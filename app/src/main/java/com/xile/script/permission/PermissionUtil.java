...
import com.xile.script.permission.callback.PermissionResultCallBack;
...
public class PermissionUtil {
    ...
    public final String RATIONAL = "rational";
    public final int PERMISSION_GRANTED = 1;
    public final int PERMISSION_RATIONAL = 2;
    public final int PERMISSION_DENIED = 3;
    public final int PERMISSION_REQUEST_CODE = 42;
